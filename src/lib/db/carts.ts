          ...
          items: {
            createMany: {
              data: localCart.items.map((item) => ({
                //map items in the anonymous cart to create new user cartItems
                productId: item.productId,
                quantity: item.quantity,
              })),
            },
